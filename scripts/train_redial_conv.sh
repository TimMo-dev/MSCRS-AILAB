...
base_run_dir="train_runs/redial_conv_run"
...
#COMMENT resume_from IF U WANNA START A NEW TRAINING 
srun --output="${outfile}" --error="${errfile}" \
  singularity exec --nv --cleanenv \
    ...
    python /home/weiyibiao/MSCRS-main/conv/src/train_conv.py \
      --dataset /home/weiyibiao/MSCRS-main/data/conv_data/redial \
      ...
      --resume_from "${WORKDIR}/train_runs/redial_conv_run/conv_train2/checkpoints/epoch_7" \
      --save_each_epoch \
      --num_train_epochs 10 \
